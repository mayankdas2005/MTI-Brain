...
const TAGLINES_MORNING: string[] = [
  ...
  'The markets have opened. Time to catch up',
  ...
  'Your numbers don\u2019t sleep. Neither should you',
  ...
  'What\u2019s the first thing you\u2019d want answered?',
];
...
const TAGLINES_AFTERNOON: string[] = [
  ...
  'Half the day down. Keep up the momentum',
  ...
  'The data is up to date. Are you?',
  'What does the data know that you don\u2019t?',
...
const TAGLINES_EVENING: string[] = [
  ...
  'End the day sharper than when you started',
  ...
  'What does closing out the day look like for you?',
  'What\u2019s the one thing worth double-checking before you leave?',
  'What would a fresh pair of eyes see in today\u2019s numbers?',
];

const TAGLINES_NIGHT: string[] = [
  'Burning the midnight oil',
  'The quiet hours. The best thinking hours',
  'Late nights make for early wins',
  ...
  'While others rest, you\u2019re building your edge',
  'What can\u2019t wait until morning?',
  'What would you want waiting for you at sunrise?',
  'What\u2019s worth losing sleep over?',
  'What if you had the answer before anyone else?',
  'What would tomorrow look like if you found the answer tonight?',
...
const TAGLINES_ANYTIME: string[] = [
  ...
  'What does good look like for your cash position?',
...
const GREETINGS: Record<string, string[]> = {
  ...
  'mon_evening':   ['Still going strong on Monday', 'Winding down Monday', 'You made it through Monday', 'One day down, four to go', 'Monday\u2019s behind you'],
  'mon_night':     ['Monday night deep dive', 'Working late on Monday', 'The week isn\u2019t over yet', 'You never stop, do you?', 'Late Monday, early edge'],

  'tue_early':     ['You\u2019re up early', 'An early start to Tuesday', 'Tuesday\u2019s just beginning', 'One day in, already ahead', 'Up before the market again'],
  'tue_morning':   ['Good morning', 'Tuesday\u2019s off to a good start', 'Morning check-in', 'Tuesday momentum is building', 'Another day, another level of focus'],
  'tue_afternoon': ['Good afternoon', 'Tuesday afternoon', 'Tuesday\u2019s in full swing', 'Tuesday energy is kicking in', 'Still pushing through Tuesday'],
  'tue_evening':   ['Good evening', 'Wrapping up Tuesday', 'A Tuesday well spent', 'Another solid day behind you', 'Tuesday\u2019s almost done'],
  'tue_night':     ['Working late', 'Burning the midnight oil', 'Tuesday night focus', 'The quiet hours are yours', 'Late night, clear head'],

  'wed_early':     ['A midweek early start', 'You\u2019re up before the sun', 'Hump day hasn\u2019t started yet', 'Midweek early mover', 'Wednesday before the world wakes up'],
  'wed_morning':   ['Good morning', 'Halfway through the week', 'Happy hump day', 'Wednesday. The pivot point', 'Midweek and moving'],
  'wed_afternoon': ['Good afternoon', 'Midweek momentum', 'Wednesday afternoon', 'Over the hump and going strong', 'Midweek clarity is setting in'],
  'wed_evening':   ['Good evening', 'Wednesday evening', 'Halfway home', 'Midweek wind-down', 'Two more days to make the week count'],
  'wed_night':     ['Midweek. Burning the midnight oil', 'Working late', 'Wednesday night deep work', 'Quiet midweek hours', 'The middle of the week, the middle of the night'],

  'thu_early':     ['Almost Friday. Almost', 'You\u2019re up early', 'Thursday before sunrise', 'One day until Friday', 'Close enough to taste the weekend'],
  'thu_morning':   ['Good morning', 'Thursday morning', 'One more day after this', 'Thursday. The home stretch', 'Almost at the finish line'],
  'thu_afternoon': ['Good afternoon', 'Thursday\u2019s flying by', 'The weekend\u2019s almost in sight', 'Thursday afternoon focus', 'One day left to make it count'],
  'thu_evening':   ['Good evening', 'Thursday evening wind-down', 'Almost there', 'Friday is just hours away', 'Thursday\u2019s done. One more to go'],
  'thu_night':     ['Working late on Thursday', 'Late night', 'Thursday night. Last push before Friday', 'Almost Friday', 'Finishing strong before the weekend'],

  'fri_early':     ['It\u2019s Friday already', 'Up early on a Friday', 'Friday before the world wakes up', 'The last early morning of the week', 'Friday. Earned'],
  'fri_morning':   ['Happy Friday', 'TGIF', 'Friday. Let\u2019s finish strong', 'Last day. Make it count', 'Friday energy. Let\u2019s go'],
  'fri_afternoon': ['Happy Friday afternoon', 'Weekend\u2019s almost here', 'Friday afternoon clarity', 'Almost at the finish line', 'Close out the week strong'],
  ...
  'fri_night':     ['Friday night and still working', 'The weekend can wait', 'Friday night deep work', 'You don\u2019t stop, even on Fridays', 'The week ends when you say it does'],

  'weekend_morning':   ['Weekend morning', 'Taking the weekend shift', 'Even weekends need clarity', 'Even the weekend can\u2019t slow you down', 'Early bird, weekend edition'],
  ...
  'weekend_evening':   ['Weekend evening', 'Quiet weekend session', 'Weekend wind-down', 'Weekend clarity', 'Weekend reflection time'],
  'weekend_night':     ['Weekend late night', 'Burning the midnight oil this weekend', 'Weekend dedication runs deep', 'No days off for the focused', 'Weekend nights give you a head start on Monday'],
};
