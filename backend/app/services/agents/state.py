...
class AnalyticsState(TypedDict):
    ...
    _own_search_terms: list[str] | None  # this turn's fresh, pre-merge search_terms only — used as next turn's "prior" input so cross-turn term carryover decays after one hop instead of accumulating indefinitely
    ...
    unresolved_sql_markers: list[str] | None  # -- UNRESOLVED CONCEPT/FILTER comments scraped from generated SQL; surfaced to user by synthesis
